...
const functionChordColorMap = {
    'Major': {
        'C': { 'IV/IV': 'flat' }, 'Db': { 'I': 'flat', 'ii': 'flat', 'IV': 'flat', 'V': 'flat', 'vi': 'flat', 'V/V': 'flat', 'IV/IV': 'flat' }, 'D': { 'iii': 'sharp', 'V/vi': 'sharp' }, 'Eb': { 'I': 'flat', 'ii': 'flat', 'iii': 'flat', 'V': 'flat', 'vi': 'flat', 'V/V': 'flat' }, 'E': { 'I': 'sharp', 'ii': 'sharp', 'iii': 'sharp', 'vi': 'sharp', 'V/vi': 'sharp' }, 'F': {}, 'Gb': { 'I': 'flat', 'ii': 'flat', 'iii': 'flat', 'IV': 'flat', 'vi': 'flat', 'V/V': 'flat', 'V/vi': 'flat' }, 'G': { 'V/V': 'sharp' }, 'Ab': { 'I': 'flat', 'ii': 'flat', 'iii': 'flat', 'IV': 'flat', 'V': 'flat', 'V/V': 'flat', 'IV/IV': 'flat' }, 'A': { 'I': 'sharp', 'ii': 'sharp', 'V': 'sharp', 'V/V': 'sharp' }, 'Bb': { 'I': 'flat', 'IV': 'flat', 'V/V': 'flat', 'IV/IV': 'flat' }, 'B': { 'I': 'sharp', 'ii': 'sharp', 'iii': 'sharp', 'V': 'sharp', 'vi': 'sharp', 'V/V': 'sharp', 'V/vi': 'sharp' }
    },
    'Natural Minor': {
        'C': { 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat', 'bII': 'flat' }, 'Db': { 'i': 'sharp', 'iv': 'sharp', 'v': 'sharp', 'ii°7': 'sharp', 'V': 'sharp' }, 'D': { 'bVI': 'flat', 'bII': 'flat' }, 'Eb': { 'i': 'sharp', 'iv': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat', 'bII': 'flat', 'V': 'sharp' }, 'E': { 'v': 'sharp' }, 'F': { 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat', 'bII': 'flat' }, 'Gb': { 'i': 'sharp', 'iv': 'sharp', 'v': 'sharp', 'bIII': 'flat', 'bVI': 'flat', 'V': 'sharp' }, 'G': { 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat', 'bII': 'flat' }, 'Ab': { 'i': 'sharp', 'v': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat', 'bII': 'flat', 'V': 'sharp' }, 'A': {}, 'Bb': { 'iv': 'flat', 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat', 'bII': 'flat' }, 'B': { 'v': 'sharp' }
    },
    'Harmonic Minor': {
        'C': { 'bIII+': 'flat', 'bVI': 'flat', 'bII': 'flat', 'bIII': 'flat' }, 'Db': { 'i': 'sharp', 'vii°': 'sharp', 'iv': 'sharp', 'V': 'sharp', 'IV': 'sharp' }, 'D': { 'vii°': 'sharp', 'bVI': 'flat', 'bII': 'flat', 'bIII': 'flat' }, 'Eb': { 'i': 'sharp', 'iv': 'sharp', 'bVI': 'flat', 'vii°': 'sharp', 'bIII+': 'flat', 'bII': 'flat', 'IV': 'sharp' }, 'E': { 'V': 'sharp', 'vii°': 'sharp' }, 'F': { 'bIII+': 'flat', 'bVI': 'flat', 'bII': 'flat', 'bIII': 'flat' }, 'Gb': { 'i': 'sharp', 'vii°': 'sharp', 'iv': 'sharp', 'V': 'sharp', 'bVI': 'flat', 'bIII': 'flat', 'IV': 'sharp' }, 'G': { 'vii°': 'sharp', 'bIII+': 'flat', 'bVI': 'flat', 'bII': 'flat', 'bIII': 'flat' }, 'Ab': { 'i': 'sharp', 'vii°': 'sharp', 'V': 'sharp', 'bIII+': 'flat', 'bVI': 'flat', 'bII': 'flat', 'IV': 'sharp' }, 'A': { 'vii°': 'sharp' }, 'Bb': { 'vii°': 'sharp', 'bIII+': 'flat', 'bVI': 'flat', 'bII': 'flat', 'bIII': 'flat' }, 'B': { 'V': 'sharp', 'vii°': 'sharp' }
    },
    'Melodic Minor': {
        'C': { 'bIII+': 'flat', 'bVI': 'flat', 'bVII': 'flat' }, 'Db': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'V': 'sharp', 'vi°': 'sharp', 'vii°': 'sharp' }, 'D': { 'bVI': 'flat', 'vii°': 'sharp' }, 'Eb': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'V': 'sharp', 'vi°': 'sharp', 'bIII+': 'flat', 'bVII': 'flat', 'vii°': 'sharp' }, 'E': { 'V': 'sharp', 'vii°': 'sharp' }, 'F': { 'bIII+': 'flat', 'bVI': 'flat', 'bVII': 'flat' }, 'Gb': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'V': 'sharp', 'vi°': 'sharp', 'bIII+': 'flat', 'vii°': 'sharp' }, 'G': { 'vii°': 'sharp' }, 'Ab': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'V': 'sharp', 'vi°': 'sharp', 'bIII+': 'flat', 'vii°': 'sharp' }, 'A': { 'vii°': 'sharp' }, 'Bb': { 'vii°': 'sharp', 'bIII+': 'flat', 'bVI': 'flat', 'bVII': 'flat' }, 'B': { 'V': 'sharp', 'vii°': 'sharp' }
    },
    'Dorian': {
        'C': { 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat' }, 'Db': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'vi°7': 'sharp', 'V': 'sharp' }, 'D': { 'bVI': 'flat' }, 'Eb': { 'i': 'sharp', 'v': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'vi°7': 'sharp', 'V': 'sharp' }, 'E': { 'v': 'sharp' }, 'F': { 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat' }, 'Gb': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'bIII': 'flat', 'V': 'sharp' }, 'G': {}, 'Ab': { 'i': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'vi°7': 'sharp', 'V': 'sharp' }, 'A': {}, 'Bb': { 'bVII': 'flat', 'bIII': 'flat', 'bVI': 'flat' }, 'B': { 'v': 'sharp' }
    },
    'Phrygian': {
        'C': { 'bVI': 'flat', 'bvii': 'flat', 'bIII': 'flat', 'bII': 'flat', 'bV': 'flat', 'bVII': 'flat' }, 'Db': { 'i': 'sharp', 'iv': 'sharp', 'v°': 'sharp' }, 'D': { 'bVI': 'flat', 'bII': 'flat', 'bV': 'flat' }, 'Eb': { 'i': 'sharp', 'iv': 'sharp', 'bvii': 'flat', 'bIII': 'flat', 'bII': 'flat', 'v°': 'sharp', 'bV': 'flat', 'bVII': 'flat' }, 'E': { 'v°': 'sharp' }, 'F': { 'bVI': 'flat', 'bvii': 'flat', 'bIII': 'flat', 'bII': 'flat', 'bV': 'flat', 'bVII': 'flat' }, 'Gb': { 'i': 'sharp', 'iv': 'sharp', 'bvii': 'flat', 'bIII': 'flat', 'bII': 'flat', 'v°': 'sharp', 'bV': 'flat' }, 'G': { 'bII': 'flat', 'bV': 'flat' }, 'Ab': { 'i': 'sharp', 'iv': 'sharp', 'bvii': 'flat', 'bIII': 'flat', 'bII': 'flat', 'v°': 'sharp', 'bV': 'flat', 'bVII': 'flat' }, 'A': { 'v°': 'sharp' }, 'Bb': { 'bVI': 'flat', 'bvii': 'flat', 'bIII': 'flat', 'bII': 'flat', 'bV': 'flat', 'bVII': 'flat' }, 'B': { 'v°': 'sharp' }
    },
    'Lydian': {
        'C': { '#iv°': 'sharp' }, 'Db': { 'I': 'flat', 'vi': 'flat', 'II': 'flat', 'V': 'flat', 'IV': 'flat', 'ii°': 'flat' }, 'D': { 'vii': 'sharp', 'iii': 'sharp', '#iv°': 'sharp' }, 'Eb': { 'I': 'flat', 'II': 'flat', 'iii': 'flat', 'vi': 'flat', 'vii': 'sharp', 'V': 'flat', 'IV': 'flat', 'ii°': 'flat' }, 'E': { 'I': 'sharp', 'II': 'sharp', 'iii': 'sharp', 'vi': 'sharp', 'vii': 'sharp', '#iv°': 'sharp' }, 'F': { '#iv°': 'sharp' }, 'Gb': { 'I': 'flat', 'II': 'flat', 'iii': 'flat', 'vi': 'flat', 'vii': 'sharp', 'V': 'flat', 'IV': 'flat', '#iv°': 'sharp' }, 'G': { 'II': 'sharp', 'vii': 'sharp', '#iv°': 'sharp' }, 'Ab': { 'I': 'flat', 'II': 'flat', 'iii': 'flat', 'V': 'flat', 'IV': 'flat', 'ii°': 'flat' }, 'A': { 'I': 'sharp', 'II': 'sharp', 'V': 'sharp', 'vii': 'sharp', '#iv°': 'sharp' }, 'Bb': { 'I': 'flat', 'vii': 'sharp', 'V': 'flat', 'IV': 'flat', 'ii°': 'flat' }, 'B': { 'I': 'sharp', 'II': 'sharp', 'iii': 'sharp', 'vi': 'sharp', 'vii': 'sharp', 'V': 'sharp', '#iv°': 'sharp' }
    },
    'Mixolydian': {
        'C': { 'bVII': 'flat', 'bVI': 'flat', 'bIII': 'flat' }, 'Db': { 'I': 'sharp', 'ii': 'sharp', 'vi': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'iii°': 'sharp' }, 'D': { 'bVI': 'flat', 'iii°': 'sharp' }, 'Eb': { 'I': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'iii°': 'sharp' }, 'E': { 'I': 'sharp', 'ii': 'sharp', 'v': 'sharp', 'vi': 'sharp' }, 'F': { 'bVII': 'flat' }, 'Gb': { 'I': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'vi': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'iii°': 'sharp' }, 'G': {}, 'Ab': { 'I': 'sharp', 'ii': 'sharp', 'IV': 'sharp', 'v': 'sharp', 'bVII': 'flat', 'bIII': 'flat', 'iii°': 'sharp' }, 'A': { 'I': 'sharp', 'ii': 'sharp', 'v': 'sharp' }, 'Bb': { 'bVII': 'flat', 'bVI': 'flat', 'bIII': 'flat' }, 'B': { 'I': 'sharp', 'ii': 'sharp', 'v': 'sharp', 'vi': 'sharp' }
    },
    'Locrian': {
        'C': { 'bII': 'flat', 'bVI': 'flat', 'biii': 'flat', 'bvii': 'flat', 'bVI+': 'flat', 'bV': 'flat' }, 'Db': { 'i°': 'sharp', 'iv': 'sharp', 'IV': 'sharp' }, 'D': { 'bII': 'flat', 'bVI': 'flat', 'bV': 'flat' }, 'Eb': { 'i°': 'sharp', 'bII': 'flat', 'bVI': 'flat', 'biii': 'flat', 'bvii': 'flat', 'bVI+': 'flat', 'bV': 'flat' }, 'E': { 'i°': 'sharp', 'iv': 'sharp' }, 'F': { 'bII': 'flat', 'bVI': 'flat', 'biii': 'flat', 'bvii': 'flat', 'bVI+': 'flat', 'bV': 'flat' }, 'Gb': { 'i°': 'sharp', 'iv': 'sharp', 'biii': 'flat', 'bvii': 'flat', 'bVI+': 'flat', 'bV': 'flat' }, 'G': { 'bII': 'flat', 'bV': 'flat' }, 'Ab': { 'i°': 'sharp', 'iv': 'sharp', 'bII': 'flat', 'bVI': 'flat', 'biii': 'flat', 'bvii': 'flat', 'bVI+': 'flat', 'bV': 'flat' }, 'A': { 'i°': 'sharp', 'iv': 'sharp' }, 'Bb': { 'bII': 'flat', 'bVI': 'flat', 'biii': 'flat', 'bvii': 'flat', 'bVI+': 'flat', 'bV': 'flat' }, 'B': { 'i°': 'sharp', 'iv': 'sharp' }
    }
};
...
const positions = {
  '10a':[9,0],'10b':[9,1],'10c':[9,2],'10d':[9,3],'3a':[2,0],'4a':[3,0],'3b':[2,1],'4b':[3,1],'3c':[2,2],'4c':[3,2],'5a':[4,0],'6a':[5,0],'5b':[4,1],'6b':[5,1],'7b':[6,1],'5c':[4,2],'6c':[5,2],'7c':[6,2],'8a':[7,0],'9a':[8,0],'8b':[7,1],'9b':[8,1],'8c':[7,2],'9c':[8,2],'8d':[7,3],'9d':[8,3],'2a':[1,0],'2b':[1,1],'2c':[1,2],'2d':[1,3],'1a':[0,0],'1b':[0,1],'1c':[0,2],'1d':[0,3]
};
...
function resizeGrid() {
  ...
  const gridAspectRatio = aspectW / aspectH;

  // Check if the screen is wider than the grid's natural aspect ratio
  if (screenAspectRatio > gridAspectRatio) {
      // On wide screens, base the size on the height, then scale up
      gridHeight = availableHeight;
      gridWidth = gridHeight * gridAspectRatio;
      
      // Increase size by 20%, but don't exceed the available width
      const scaledWidth = Math.min(gridWidth * 1.2, availableWidth);
      gridWidth = scaledWidth;
      gridHeight = scaledWidth / gridAspectRatio;

  } else {
      // On taller screens, use the original logic (fit to width)
      gridWidth = availableWidth;
      gridHeight = availableWidth / gridAspectRatio;
  }
